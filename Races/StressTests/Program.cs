...
namespace StressTests
{
    internal class Program
    {
        ...
        private static void TestDataSending(int iterationNumber)
        {
            ...
            var client = new Client("192.168.148.1");
            client.OnDataGot += Client_OnGetData;
            server.OnDataGot += Server_OnGetData;
            ...
            Console.WriteLine($"Результат, полученный клиентом от сервера: {_clientResult.Angle}");
            ...
            Console.WriteLine($"Результат, полученный клиентом от сервера: {_serverResult.Angle}");
